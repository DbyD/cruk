...
<li class="clickAble <?php getCurrentFolder('my-account'); ?>" data-type="gourl" data-url="<?=HTTP_PATH?>my-account"><i class="icon-icons_account"></i>My Awards</li>
...
<li class="clickAble <?php getCurrentFolder('redeem'); ?>" data-type="gourl" data-url="<?=HTTP_PATH?>redeem"><i class="icon-icons_redeem"></i>Shop</li>
...
<?php }
	if($_SESSION['user']-> departmentHead() == 'YES' ||$_SESSION['user']->SuperUser == 'YES' || $_SESSION['user']->SuperUser == 'Y') { ?>
