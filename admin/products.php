...
<div id="content" class="large-8 large-push-2 columns">
	...
	<div class="row contentFill mCustomScrollbar height605 " data-mcs-theme="dark-2" id="productscrollbar">
				...
				<form method="post" action="" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="large-9 columns">
							<input type="text" placeholder="" name="title" value="<?php echo isset( $pr['aTitle'] ) ? $pr['aTitle'] : ''; ?>"/>
						</div>
					</div>
					<div class="row">
						<div class="large-3 columns">
						...
						<div class="large-9 columns">
							<input type="file" placeholder=""  name="fileImage"/>
						</div>
					</div>
					<div class="row">
						<div class="large-3 columns">
							<label>Value Options Points: </label>
						</div>
						<div class="large-9 columns">
...
<?php if( isset( $pr['prID']) ){?>
<script>$("#productscrollbar").mCustomScrollbar("scrollTo","bottom");</script>
<?php } ?>
</body></html>