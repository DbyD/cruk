		...
		<div class="row">
			<div class="large-12 columns">
				<div class="medium-8 columns leftnp">
					...
					<?php 
					if ($_GET['status']=='done'){
						echo '<p>Thank you for activating your account.</p><p>You can now <a href="<?=$path?>index.php">click here </a> to log in to access the portal.</p>';
					} else {
						echo '<p>We were unable to activate your account.</p><p>Please contact the help desk on 012345678 or email: <a href="<?=$path?>mailto:help@xexec.com">help@xexec.com</a> to assist.</p>';
					}
					?>
					</div>
				</div>
