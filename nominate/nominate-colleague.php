...
<div id="content" class="large-8 large-push-2 columns">
	...
	?>
		<div class="callout panel white contentFill" id="nominateOptions">
			...
			<div class="row withPadding noMargin">
				<div class="medium-12 columns">
					<textarea name="personalMessage" id="personalMessage" placeholder="Example: Your dedication and passion is infectious, I am proud of you. Keep up the good work." maxlength="300"><?=$_SESSION['nominee']->personalMessage?></textarea>
