...
<div id="content" class="large-8 large-push-2 columns">
	<div class="title">
			...
			<i class="icon-icons_thickrightarrow smalli"></i> <span class="subSubTitle"><?=$_SESSION['teamnominee']->full_name();?></span>
			<div class="titlePhoto">
				<img src="<?=HTTP_PATH.$_SESSION['teamnominee']->Photo?>" alt="" onerror="this.src='<?=HTTP_PATH?>images/no-photo.png'"/>
			</div>
		</div>
	<div class="row">
		<div class="callout panel white contentFill">
			<div class="row withPadding ">
				<div class="medium-12 columns">
					...
					<p>As you are also the assigned Approver for this nomination, this award has automatically be approved and your Thank you Certificate has been sent to <?=$_SESSION['teamnominee']->full_name();?>.</p>
					<?php } else { ?>
					<p>Your Thank you Certificate has been sent to <?=$_SESSION['teamnominee']->full_name();?>.</p>
					<?php } ?>
